...
//	}
     ...
     *获取jar所在目录的路径
     */
    public static String getJarPath(Object thisObject, String filePath)
    {
        String path = thisObject.getClass().getProtectionDomain().getCodeSource().getLocation().getPath();
