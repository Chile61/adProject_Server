...
public class DruidProperties {
    ...
    public void wallConfig(WallConfig wallConfig) {
        //允许一次执行多条语句
    ...
    public Boolean getMultiStatementAllow() { return multiStatementAllow; }

    public void setMultiStatementAllow(Boolean multiStatementAllow) { this.multiStatementAllow = multiStatementAllow; }
}
