(function() {
    ...
    var $WebUploadMutiple = function(pictureId) {
        this.pictureId = pictureId;
        this.uploadBtnId = pictureId + "BtnId";
        this.uploadPreId = pictureId + "PreId";
        this.uploadUrl = Feng.ctxPath + '/productImage/upload';
    ...
    $WebUploadMutiple.prototype = {
        /**
         * 初始化webUploaderMutiple
         */
        init : function() {
         ...
         */
        create : function() {
            var webUploaderMutiple = WebUploadMutiple.create({
                auto : true,
                pick : {
                    id : '#' + this.uploadBtnId,
                    multiple : multiple,// 可以上传多个
                },
                accept : {
                    title : 'Images',
    ...
    window.$WebUploadMutiple = $WebUploadMutiple;
