...
public class DictController extends BaseController {
     ...
     * 获取字典的店铺类型的tree列表
     */
    @ApiOperation(value="获取字典的tree列表", notes="根据名称获取字典的tree列表")
    @RequestMapping(value = "/shopTypeTree",method = RequestMethod.POST)
    @ResponseBody
    public List<ZTreeNode> tree() {
        List<ZTreeNode> tree = this.dictDao.getDictTree("店铺类型");
