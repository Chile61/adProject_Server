...
public class TableService {
     ...
     * 获取当前数据库指定表所有的字段信息
     */
    public List<Map<String, Object>> getAllColumns(String tabName) {
        String sql = "SELECT COLUMN_NAME,column_comment FROM INFORMATION_SCHEMA.Columns WHERE table_name='" + tabName + "' AND table_schema='" + dbName +"'";
        return SqlRunner.db().selectList(sql);
    }
}
